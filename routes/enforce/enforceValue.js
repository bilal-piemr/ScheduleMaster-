...
{ 
db.query(
    "INSERT INTO assignedData (faculty,subject,classroom,dayId,semister,period) VALUES ('"+request.body.faculty+"', '"+request.body.subject+"','"+request.body.classRoom+"','"+request.body.period+"','"+request.body.semister+"','"+request.body.days+"'  )",function(err,result){
      if (err) {
